...
const multer = require('multer') //middleware do Node.js usado junto com o Express para lidar com uploads de arquivos
const path = require('path')     // módulo para trabalhar com caminhos absolutos
...
app.post('/upload', (req, res) => {
    upload(req, res, err => {
        ...
        // Retorna também o nome do arquivo salvo para confirmar
        res.end(`Concluído! Arquivo salvo como: ${req.file.filename}`)
    })
})
